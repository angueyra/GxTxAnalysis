classdef gxtx_fitHist<hekaGUI
    ...
    methods
        ...
        function hGUI=gxtx_fitHist(hekadat,params,fign) 
          ...
          set(lH,'LineStyle','--','Marker','none','LineWidth',2,'MarkerSize',5,'Color',[.75 .75 .75])
          set(lH,'DisplayName','cLine2')
          %o line
          lH=line([hGUI.hekadat.stAxis(1) hGUI.hekadat.stAxis(end)],[NaN NaN],'Parent',hGUI.figData.plotSub);
          set(lH,'LineStyle','--','Marker','none','LineWidth',2,'MarkerSize',5,'Color',[.75 .75 .75])
          set(lH,'DisplayName','oLine2')
          %hath line
          lH=line([hGUI.hekadat.stAxis(1) hGUI.hekadat.stAxis(end)],[NaN NaN],'Parent',hGUI.figData.plotSub);
          set(lH,'LineStyle','--','Marker','none','LineWidth',2,'MarkerSize',5,'Color',[.75 .75 .75])
...
%             set(hHNow,'XData',currHistY,'YData',currHistX,'Color',colors(PlotNow,:))
        ...
        function fittingCall(hGUI,~,~)
            ...
            % plot line
            lHNow=findobj('DisplayName','cLine2');
            set(lHNow,'YData',[c_coeffs(1) c_coeffs(1)])
            lHNow=findobj('DisplayName','oLine2');
            set(lHNow,'YData',[o_coeffs(1) o_coeffs(1)])
        ...
        function lockButtonCall(hGUI,~,~)
            ...
            hGUI.hekadat.hath=(hGUI.params.hist_c(1)+hGUI.params.hist_o(1))/2;
